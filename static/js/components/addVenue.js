  ...
  <div class="row">
    <div  Venues class="col-md-4 mb-3">
      <div class="card rectangle-card bg-light">
        <div class="card-body">
        <input v-model="venue_name"  ref="venue_name" type="text" id="venue_name" placeholder="Enter Venue name" style="width: 100%; padding: 12px 20px; margin: 8px 0; display: inline-block; border: 1px solid #ccc; box-sizing: border-box; border-radius: 4px;">
        <input v-model="place"  ref="place" type="text" id="place" placeholder="Enter Venue place" style="width: 100%; padding: 12px 20px; margin: 8px 0; display: inline-block; border: 1px solid #ccc; box-sizing: border-box; border-radius: 4px;">
        <input v-model="capacity"  ref="capacity" type="text" id="capacity" placeholder="Enter Venue capacity" style="width: 100%; padding: 12px 20px; margin: 8px 0; display: inline-block; border: 1px solid #ccc; box-sizing: border-box; border-radius: 4px;">
